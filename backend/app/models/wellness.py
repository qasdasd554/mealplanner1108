"""Dzienne nawodnienie i aktywność fizyczna — uzupełnienie dziennika
kalorii o dwie rzeczy, których dotąd nie dało się zapisać.

Dwie osobne tabele, a nie jedna wspólna „dzienna notatka": nawodnienie
...
Wciśnięcie obu w jedną tabelę wymusiłoby albo duplikowanie sumy wody
przy każdym treningu, albo sztuczne wpisy aktywności o zerowej wartości
tylko po to, żeby zapisać wodę.
"""
