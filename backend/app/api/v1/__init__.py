...
from app.api.v1.purchase_campaigns import router as purchase_campaigns_router
...
router.include_router(purchase_campaigns_router, prefix="/purchase-campaigns", tags=["Purchase Campaigns"])
