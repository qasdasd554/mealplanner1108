...
const List<CookingTip> kCookingTips = [
  CookingTip(
    ...
    tip:
        'Zanim odcedzisz makaron, zachowaj pół szklanki wody z gotowania. '
  ...
  CookingTip(
    ...
    tip:
        'Solenie wody na makaron czy ziemniaki PO zagotowaniu, nie przed, '
  ...
  CookingTip(
    ...
    tip:
        'Schłodzenie cebuli w lodówce przez 15-20 minut przed krojeniem '
  ...
  CookingTip(
    ...
    tip:
        'Skrop przekrojone awokado sokiem z cytryny lub limonki — kwas '
  ...
  CookingTip(
    ...
    tip:
        'Opłucz ryż pod zimną wodą, aż woda przestanie być mętna — usuwa '
  ...
  CookingTip(
    ...
    tip:
        'Wyjmij mięso z lodówki 20-30 minut przed smażeniem czy grillowaniem '
  ...
  CookingTip(
    ...
    tip:
        'Zaraz po ugotowaniu na twardo wrzuć jajka do zimnej wody na kilka '
  ...
  CookingTip(
    ...
    tip:
        'Pietruszkę, koperek czy natkę trzymaj w szklance z odrobiną wody '
  ...
  CookingTip(
    ...
    tip:
        'Przed wyciśnięciem przetocz cytrynę czy limonkę mocno dłonią po '
  ...
  CookingTip(
    ...
    tip:
        'Zbyt duża ilość składników naraz obniża temperaturę patelni — '
  ...
  CookingTip(
    ...
    tip:
        'Tępy nóż wymaga więcej siły i częściej się ześlizguje — to on, nie '
  ...
  CookingTip(
    ...
    tip:
        'Posiekane świeże zioła zalane oliwą i zamrożone w kostkach lodu to '
  ...
  CookingTip(
    ...
    tip:
        'Skrop czerstwą bułkę czy chleb odrobiną wody i podgrzej kilka minut '
  ...
  CookingTip(
    ...
    tip:
        'Dodaj do gotującego się sosu obrany kawałek surowego ziemniaka na '
  ...
  CookingTip(
    ...
    tip:
        'Odrobina soku z cytryny, octu albo jogurtu w marynacie pomaga '
  ...
  CookingTip(
    ...
    tip:
        'Rozgrzej suchą patelnię, dopiero potem dodaj olej czy masło — '
  ...
  CookingTip(
    ...
    tip:
        'Przechowywane razem przyspieszają sobie nawzajem kiełkowanie i '
  ...
  CookingTip(
    ...
    tip:
        'Krótko gotuj brokuły czy fasolkę w osolonym wrzątku, a zaraz potem '
  ...
  CookingTip(
    ...
    tip:
        'Spryskaj łyżkę odrobiną oleju przed nabraniem miodu — spłynie '
  ...
  CookingTip(
    ...
    tip:
        'Zamroź niedopite wino w kostkach lodu — świetnie sprawdzi się '
  ...
  CookingTip(
    ...
    tip:
        'Połóż drewnianą łyżkę w poprzek garnka z gotującą się wodą lub '
  ...
  CookingTip(
    ...
    tip:
        'Przepłucz zwykły twaróg pod bieżącą zimną wodą i odsącz na sicie. '
  ...
  CookingTip(
    ...
    tip:
        'Włóż kawałek żółtego sera na pół godziny do zamrażarki przed '
  ...
  CookingTip(
    ...
    tip:
        'Zanim dodasz śmietanę do gorącej zupy, wymieszaj ją wcześniej z '
  ...
  CookingTip(
    ...
    tip:
        'Surowe żółtko lekko ubij z odrobiną wody lub mleka, zanim dodasz '
  ...
  CookingTip(
    ...
    tip:
        'Włóż sałatę czy zioła na kilka minut do miski zimnej wody z '
  ...
  CookingTip(
    ...
    tip:
        'Kilka mocnych uderzeń denkiem słoika o krawędź blatu (nie samym '
  ...
  CookingTip(
    ...
    tip:
        'Zamiast kroić zimne masło na kawałki do ciasta kruchego, zetrzyj '
  ...
  CookingTip(
    ...
    tip:
        'Przykryj kostkę masła prosto z lodówki podgrzaną (np. wodą z '
  ...
  CookingTip(
    ...
    tip:
        'Odrobina świeżo mielonego czarnego pieprzu na pokrojonych '
