...
class _PlanConfigScreenState extends State<PlanConfigScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (authProvider.currentUser?.preferredStoreId != null) {
        storeProvider.selectStoreById(
          authProvider.currentUser!.preferredStoreId!,
        );
        setState(() {
      ...
      final profileDiet =
          authProvider.currentUser?.dietaryPreferences?['diet'] as String?;
      if (profileDiet != null &&
          kDietOptions.any((d) => d['name'] == profileDiet)) {
        setState(() {
  ...
  Future<void> _generate() async {
    ...
    if (mounted) {
      if (success) {
        ...
        final errorMsg =
            mealPlanProvider.errorMessage ?? 'Nie udało się wygenerować planu';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Nowy plan posiłków')),
      body: Stack(
        children: [
                ...
                SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                          ...
                          children:
                              [
                                ...
                                return FilterChip(
                                  ...
                                  selectedColor: AppTheme.primaryTintColor,
                                  checkmarkColor: AppTheme.actionPrimaryColor,
                                  backgroundColor: AppTheme.controlFillColor,
                                  side: BorderSide(
                                    color:
                                        isSelected
                                            ? AppTheme.actionPrimaryColor
                                            : AppTheme.outlineColor,
                                    width: AppTheme.isDark ? 1.4 : 1,
                                  ),
                      ...
                      ElevatedButton(
                        onPressed:
                            mealPlanProvider.isGenerating ? null : _generate,
                        child: Text(
